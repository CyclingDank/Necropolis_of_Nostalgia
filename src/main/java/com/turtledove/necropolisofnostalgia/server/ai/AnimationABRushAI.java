...
public class AnimationABRushAI <T extends NecropolisEntity & IAnimatedEntity> extends AnimationAI<T> {
    public AnimationABRushAI(T entity, Animation animation)
    {
    ...
    public void updateTask()
    {
        ...
        if (this.entity.getAnimationTick() == 6)
        {
            ...
            this.entity.motionX = dX / 2.0;
            this.entity.motionZ = dZ / 2.0;
        }
