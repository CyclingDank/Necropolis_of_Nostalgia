...
public class EntityHealingCircle extends EntityCasted
{
    private int ticksAlive;
    private int ticksLifetime;

    public EntityHealingCircle(World worldIn)
    {
        super(worldIn);
        this.setSize(5.0F, 1.0F);
    }
    public EntityHealingCircle (World worldIn, EntityPlayer player, int ticksLifetime)
    {
