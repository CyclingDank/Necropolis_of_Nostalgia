...
public class EntityRita extends NecropolisNPC
{
    private static final Animation[] ANIMATIONS = {};

    public EntityRita(World worldin)
    {
        super(worldin);
        ...
        this.primaryQuestID[0] = 6;
        this.primaryQuestID[1] = 7;
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(5, new EntityAIDoFarming(this, 0,0.1875, false));
