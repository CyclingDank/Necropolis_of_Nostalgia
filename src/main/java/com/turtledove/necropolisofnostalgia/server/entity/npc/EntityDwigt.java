...
public class EntityDwigt extends NecropolisNPC
{
    private static final Animation[] ANIMATIONS = {};

    public EntityDwigt(World worldin)
    {
        super(worldin);
        ...
        this.primaryQuestID[0] = 4;
        this.primaryQuestID[1] = 5;
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(5, new EntityAIDoFarming(this, 2,0.1875, false));
