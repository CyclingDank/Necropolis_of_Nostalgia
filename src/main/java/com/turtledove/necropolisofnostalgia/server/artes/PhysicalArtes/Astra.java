...
public class Astra  extends PhysicalArte
{
    public Astra()
    {
        super(new Vec3d(0.0D,0.0D,0.0D),new int[]{10},10,new Vec3d(0.0D,0.0D,0.0D),30, 15);
        this.arte_name = "Astra";
        this.arte_desc = "Base Arte: If airborne, sends foe plummeting to the ground.";
