        ...
        else
        {
            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                        ...
                        && worldIn.getBlockState(blockpos.down()).getMaterial() == Material.GROUND)
                {
                    ...
                    worldIn.setBlockState(blockpos1, BlockHandler.CAT_TAIL.getDefaultState());
                    ...
                    worldIn.setBlockState(blockpos1,  BlockHandler.CAT_TAIL.getDefaultState(), 11);
