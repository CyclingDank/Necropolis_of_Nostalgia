...
public class ItemStoneRapier extends ItemSword
{
    private float attack_damage;
    public ItemStoneRapier(Item.ToolMaterial material)
    {
        super(material);
        this.setUnlocalizedName("StoneRapier");
        this.setRegistryName("stone_rapier");
