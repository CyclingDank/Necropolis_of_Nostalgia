...
public class ItemRiceSeed extends Item
{
    ItemRiceSeed(String name)
    {
        ...
        else
        {
            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                        ...
                        && worldIn.getBlockState(blockpos.down()).getMaterial() == Material.GROUND)
                {
                    ...
                    worldIn.setBlockState(blockpos1, BlockHandler.RICE.getDefaultState());
                    ...
                    worldIn.setBlockState(blockpos1,  BlockHandler.RICE.getDefaultState(), 11);
