...
public class EntityBooglin extends NecropolisEntity
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(Necropolis_of_Nostalgia.CONFIG.booglinMaxHealth);
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (closestEntity != null && closestEntity.isEntityAlive())
            {
                ...
                else if (Necropolis_of_Nostalgia.CONFIG.booglinGrief)
                {
