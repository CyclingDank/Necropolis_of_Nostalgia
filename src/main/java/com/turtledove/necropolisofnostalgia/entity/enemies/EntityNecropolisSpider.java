...
public class EntityNecropolisSpider extends NecropolisEntity
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(Necropolis_of_Nostalgia.CONFIG.spiderMaxHealth);
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if ((cause.getDamageType() == "melee") || cause.getDamageType() == "arte" || cause.getDamageType() == "physical_artes")
        {
            if (!this.world.isRemote)
            {
                ...
                this.entityDropItem(new ItemStack(Items.STRING, 7, 0), 0.0F);
            }
        }
    }
