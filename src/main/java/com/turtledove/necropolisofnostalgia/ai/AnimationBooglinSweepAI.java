...
public class AnimationBooglinSweepAI  <T extends NecropolisEntity & IAnimatedEntity> extends AnimationAI<T> {
    public AnimationBooglinSweepAI(T entity, Animation animation) {
    ...
    public void updateTask() {
        ...
        else if (this.entity.getAnimationTick() == 10)
        {
