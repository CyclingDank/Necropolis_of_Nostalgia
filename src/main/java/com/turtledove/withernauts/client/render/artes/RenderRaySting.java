...
public class RenderRaySting  implements ArteRenderBase
{
    ...
    public void transformSwordSideFirstPerson(EnumHandSide hand, float equip_ratio,  float swing_ratio)
    {
        ...
        {
            GlStateManager.translate((float)i * 0.125F  - swing_ratio * 0.75F + 0.1F, swing_ratio - 0.9F, -0.52F);
        ...
        {
            f = -0.8F * MathHelper.sin(MathHelper.sqrt(swing_ratio) * (float) Math.PI * 2F);
            GlStateManager.translate(0.0F,  -0.25f, -f - 1F);
