...
public class RenderRevolvingSlash  implements ArteRenderBase
{
    ...
    public void transformSwordSideFirstPerson(EnumHandSide hand, float equip_ratio,  float swing_ratio)
    {
        ...
        {
            GlStateManager.translate((float)i * 0.125F - 0.15F, -0.3F, -0.52F);
            GlStateManager.rotate( 90.0F, 0.0F, 0.0F, 1.0F);
            GlStateManager.rotate(-360F * swing_ratio,1.0F, 0.0F,0.0F);
            GlStateManager.rotate( -70.0F, 1.0F, 0.0F, 0.0F);
        }
        else
        {
            GlStateManager.translate((float)i * 0.125F - 0.15F, -0.3F, -0.52F + -swing_ratio * 0.125F);
