...
public class RenderDemonicChaos implements ArteRenderBase {
    ...
    public void transformSwordFirstPerson(EnumHandSide hand, float swing_ratio)
    {
        ...
        {
            f = MathHelper.cos(swing_ratio * swing_ratio * (float)Math.PI);
            GlStateManager.translate((float)i * 0.56F  - swing_ratio * 1.75F + 0.9F, swing_ratio * 0.25F - 0.4F, -0.52F);
