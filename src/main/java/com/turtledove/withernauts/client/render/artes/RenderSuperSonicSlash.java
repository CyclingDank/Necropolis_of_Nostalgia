...
public class RenderSuperSonicSlash implements ArteRenderBase {
    ...
    public void transformSwordSideFirstPerson(EnumHandSide hand, float equip_ratio,  float swing_ratio)
    {
        ...
        else
        {
            ...
            GlStateManager.rotate(-120.0F + f * f * 25F, 0.0F, 0.0F, 1.0F);
            GlStateManager.rotate(-45.0F + 35.0F * f, 1.0F, 0.0F, 0.0F);
            GlStateManager.rotate( -25.0F, 0.0F, 1.0F, 0.0F);
        }
    }
