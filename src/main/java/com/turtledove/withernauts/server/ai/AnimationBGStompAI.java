...
public class AnimationBGStompAI<T extends NecropolisEntity & IAnimatedEntity> extends AnimationAI<T> {
    public AnimationBGStompAI(T entity, Animation animation) {
    ...
    public void updateTask() {
        ...
        if (entity.getAnimationTick() == 16)
        {
            EntityDestructionField cast = new EntityDestructionField(this.entity.world, this.entity, new Vec3d(this.entity.posX, this.entity.posY, this.entity.posZ), 25.0f);
            this.entity.world.spawnEntity(cast);
        }
    }
