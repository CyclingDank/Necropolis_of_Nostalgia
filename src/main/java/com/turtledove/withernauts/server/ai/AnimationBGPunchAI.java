...
public class AnimationBGPunchAI<T extends NecropolisEntity & IAnimatedEntity> extends AnimationAI<T> {
    public AnimationBGPunchAI(T entity, Animation animation) {
