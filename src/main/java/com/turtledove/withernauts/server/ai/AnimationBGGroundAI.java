...
public class AnimationBGGroundAI<T extends NecropolisEntity & IAnimatedEntity> extends AnimationAI<T> {
    public AnimationBGGroundAI(T entity, Animation animation) {
    ...
    public void updateTask() {
        ...
        else if (entity.getAnimationTick() == 10)
        {
            this.entity.playSound(NecropolisSounds.ERUPTION_CAST, 0.7F, 0.7F);
        }
        else if (entity.getAnimationTick() == 80)
        {
            Vec3d []pbPos = new Vec3d[] {
                    new Vec3d(this.entity.posX+2.6, this.entity.posY, this.entity.posZ),
                    new Vec3d(this.entity.posX-2.6, this.entity.posY, this.entity.posZ),
                    new Vec3d(this.entity.posX, this.entity.posY, this.entity.posZ+2.6),
                    new Vec3d(this.entity.posX, this.entity.posY, this.entity.posZ-2.6),
                    new Vec3d(this.entity.posX+2.3, this.entity.posY, this.entity.posZ+2.3),
                    new Vec3d(this.entity.posX-2.3, this.entity.posY, this.entity.posZ-2.3),
                    new Vec3d(this.entity.posX+2.3, this.entity.posY, this.entity.posZ-2.3),
                    new Vec3d(this.entity.posX-2.3, this.entity.posY, this.entity.posZ+2.3)};
            ...
            for (int i = 0; i < 8; i++)
            {
                EntityPB entityPB1 = new EntityPB(this.entity.world, this.entity, 1.0F);
                if (this.entity.world.isAirBlock(new BlockPos(pbPos[i])) && !this.entity.world.isAirBlock((new BlockPos(pbPos[i]).down())))
                {
                    entityPB1.setPosition(pbPos[i].x, pbPos[i].y, pbPos[i].z);
                    this.entity.world.spawnEntity(entityPB1);
