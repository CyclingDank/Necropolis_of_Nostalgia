...
public class Fleche extends PhysicalArte
{
    public Fleche()
    {
        super(new Vec3d(0.0D,0.0D,0.0D),new int[]{8},10,new Vec3d(0.0D,0.0D,0.0D),0, 0);
        this.setArteWeapon(1);
        this.arte_name = "Fleche";
        this.arte_desc = "Base Arte: Pierces and knocks enemies back with a single elegant thrust.";
    }
    @Override
