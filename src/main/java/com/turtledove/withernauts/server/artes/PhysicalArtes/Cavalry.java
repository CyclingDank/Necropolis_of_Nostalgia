...
public class Cavalry  extends PhysicalArte
{
    public Cavalry()
    {
        super(new Vec3d(0.0D,0.0D,0.0D),new int[]{5,5},10,new Vec3d(0.0D,0.0D,0.0D),0, 30);
        this.arte_name = "Cavalry";
        this.arte_desc = "Base Arte: A quick lunging attack.";
