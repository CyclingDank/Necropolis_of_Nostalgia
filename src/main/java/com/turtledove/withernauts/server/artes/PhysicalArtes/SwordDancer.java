...
public class SwordDancer  extends PhysicalArte
{
    public SwordDancer()
    {
        super(new Vec3d(0.0D,0.0D,0.0D),new int[]{6,6,6,6,6},30,new Vec3d(0.0D,0.0D,0.0D),22, 0);
        this.arte_name = "Sword Dancer";
        this.arte_desc = "Base Arte: Traps a foe in the movement of one's blade.";
    }
    @Override
