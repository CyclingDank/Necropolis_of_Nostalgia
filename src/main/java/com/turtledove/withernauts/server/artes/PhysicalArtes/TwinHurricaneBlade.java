...
public class TwinHurricaneBlade extends PhysicalArte
{
    public TwinHurricaneBlade()
    {
        super(new Vec3d(0.0D,0.0D,0.0D),new int[]{4,4,4,4},16,new Vec3d(0.0D,0.0D,0.0D),32, 0);
        this.arte_name = "Twin Hurricane Blade";
        this.arte_desc = "Altered Arte: Sends a foe into the air, then knocks them back down several times.";

        this.isBase = false;
        this.tUsage = new ArteUsage[1];
        this.tUsage[0] = new ArteUsage(9, 100);
    }
    @Override
