...
public class ItemGoldRapier extends ItemSword
{
    private float attack_damage;
    public ItemGoldRapier(Item.ToolMaterial material)
    {
        super(material);
        this.setUnlocalizedName("GoldRapier");
        this.setRegistryName("gold_rapier");
