...
public class ItemIronRapier extends ItemSword
{
    private float attack_damage;
    public ItemIronRapier(Item.ToolMaterial material)
    {
        super(material);
        this.setUnlocalizedName("IronRapier");
        this.setRegistryName("iron_rapier");
